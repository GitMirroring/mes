...
(define-public m2-planet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0wv1l9ngf86wmh9pliik6r9j8yibq6dcm0bh0jlqn5cffbi33igx"))))
...
(define-public nyacc-2.00.0
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "08ssi79dpwhvkfbll02z6bx67r3xgnxvlkrnqir4d08m4fbid6h8"))
              (modules '((guix build utils)))
              (snippet
               '(substitute* "configure"
                  (("GUILE_GLOBAL_SITE=\\$prefix.*")
...
(define-public nyacc-2.00.6
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05397dqxv6sargkmz8kbgbrjvwcjrqcqc91bkmfxgmwm4a9sdg6i"))
              (modules '((guix build utils)))
              (snippet
               '(substitute* "configure"
                  (("GUILE_GLOBAL_SITE=\\$prefix.*")
...
(define-public nyacc-2.02.4
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ml38lwhdd49b90mmx4aggccrkp80vxy13g4z53ma5d11gw767hy"))
              (modules '((guix build utils)))
              (snippet
               '(substitute* "configure"
                  (("GUILE_GLOBAL_SITE=\\$prefix.*")
...
(define-public mes
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32 #!mes!# "0pgjzlynfzdfq5xrxirvsrj4sdvnwq99s6xxwfhzhjga8zm40fhq"))))
    (build-system gnu-build-system)
    (supported-systems '("aarch64-linux" "armhf-linux" "i686-linux"
                         "x86_64-linux" "riscv64-linux"))
    (propagated-inputs (list mescc-tools nyacc-3.00.1))
    (native-inputs
     (append
      (list guile-3.0)
